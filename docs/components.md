...
| `src/sensor_hts221.c` | Delayed work fetching HTS221 readings. | Produces plaintext samples before enabling encryption, emits MAC-tagged frames in Curve25519 mode, toggles LED, and notifies supervisor heartbeats. See `docs/sensor_hts221.md`. |
